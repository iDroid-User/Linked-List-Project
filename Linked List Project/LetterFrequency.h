...
// Add your both class definitions here
class LetterNode { // Defined according to UML diagram
    public:
        ...
        ~LetterNode() { //Complete; just prints to cout
...
class LetterFrequencyList { // Not yet Defined according to UML diagram
    public:
        LetterFrequencyList() {
